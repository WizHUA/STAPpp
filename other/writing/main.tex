...
% GB 3102.11-1993 数学符号规范
% 物理常数（正体）
\newcommand{\E}{\mathrm{E}}           % 弹性模量
\newcommand{\pnu}{\upnu}             % 泊松比（使用upright nu）
\newcommand{\A}{\mathrm{A}}           % 面积
\newcommand{\thick}{\mathrm{t}}       % 厚度

% 矢量和矩阵（斜粗体）
\renewcommand{\mathbf}[1]{\boldsymbol{#1}}

% 已定义函数（正体）
\DeclareMathOperator{\Det}{det}      % 行列式函数
